...
// Interface for a general product (used for frontend/POS display)
// This is the one that needs to be explicitly exported for demo/page.tsx
export interface Product { // ADDED: 'export' keyword here
  id: string;
  name: string;
  description: string;
  category: string;
...
export interface AdminProduct extends Product { // Extends the base Product interface
  costPrice: number;
  stock: number;
  sku: string;
...
export const SAMPLE_ADMIN_PRODUCTS: AdminProduct[] = [
  {
    ...
    description: 'A rich and aromatic blend, perfect for espresso. Notes of dark chocolate and caramel.',
    ...
    supplierId: 'SUP001',
    imageUrl: '[https://placehold.co/400x400/FF0000/FFFFFF?text=Coffee+Blend](https://placehold.co/400x400/FF0000/FFFFFF?text=Coffee+Blend)',
    icon: '☕',
    isActive: true,
    createdAt: '2025-01-01T10:00:00Z',
    lastUpdated: '2025-06-01T14:30:00Z',
    images: [
      { id: 'img_1_a', url: '[https://placehold.co/400x400/FF0000/FFFFFF?text=Coffee+Blend+1](https://placehold.co/400x400/FF0000/FFFFFF?text=Coffee+Blend+1)', altText: 'Espresso Blend bag', isThumbnail: true },
      { id: 'img_1_b', url: '[https://placehold.co/400x400/00FF00/000000?text=Coffee+Bean+2](https://placehold.co/400x400/00FF00/000000?text=Coffee+Bean+2)', altText: 'Roasted coffee beans', isThumbnail: false }
    ],
    variants: [
  ...
  },
  {
    ...
    supplierId: 'SUP002',
    imageUrl: '[https://placehold.co/400x400/FFFF00/000000?text=Croissant](https://placehold.co/400x400/FFFF00/000000?text=Croissant)',
    icon: '🥐',
    isActive: true,
  ...
  },
  {
    ...
    supplierId: 'SUP001',
    imageUrl: '[https://placehold.co/400x400/0000FF/FFFFFF?text=Green+Tea](https://placehold.co/400x400/0000FF/FFFFFF?text=Green+Tea)',
    icon: '🍵',
